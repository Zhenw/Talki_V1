#ifndef __IR_DRIVER_LIB
#define __IR_DRIVER_LIB
...
#if defined(IR_RC_USE_BLE_SYNC)
    #define IR_BLE_SYNC    1
#else
    #define IR_BLE_SYNC    0
#endif
...
typedef struct {
    uint16_t ir_freq_carrier_on;
    uint16_t ir_freq_carrier_off;
