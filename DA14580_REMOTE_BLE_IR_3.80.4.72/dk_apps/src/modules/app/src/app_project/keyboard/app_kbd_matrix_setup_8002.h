...
#ifndef _APP_KBD_MATRIX_SETUP_8002_H_
#define _APP_KBD_MATRIX_SETUP_8002_H_
 ...
 * @ingroup HID
 *
 * @brief HID (Remote control) Application matrix of setup #2.
 *
 * @{
 ****************************************************************************************
 */
...
#endif //_APP_KBD_MATRIX_SETUP_8002_H_
