...
#ifndef _APP_KBD_KEY_MATRIX_SETUP_8001_H_
#define _APP_KBD_KEY_MATRIX_SETUP_8001_H_
 ...
 * @ingroup HID
 *
 * @brief HID (Remote control) Application GPIO reservations for the matrix of setup #8001.
 *
 * @{
 ****************************************************************************************
 */
...
#define KBD_RED_LED_PIN		GPIO_PIN_6

#define IR_LED_PORT	GPIO_PORT_3
...
#define DECLARE_LED_PINS                                                             	\
    {                                                                                	\
        RESERVE_GPIO(        BLUE_LED,    GPIO_PORT_2,     GPIO_PIN_6,    PID_GPIO ) 	\
        RESERVE_GPIO(         RED_LED,    GPIO_PORT_2,     GPIO_PIN_5,    PID_GPIO ) 	\
    }

#define DECLARE_KEYBOARD_GPIOS                                                       	\
    {                                                                                	\
        RESERVE_GPIO(     INPUT_COL_0,    GPIO_PORT_2,     GPIO_PIN_2,    PID_GPIO ) 	\
        RESERVE_GPIO(     INPUT_COL_1,    GPIO_PORT_3,     GPIO_PIN_3,    PID_GPIO ) 	\
        RESERVE_GPIO(     INPUT_COL_2,    GPIO_PORT_2,     GPIO_PIN_1,    PID_GPIO ) 	\
        RESERVE_GPIO(     INPUT_COL_3,    GPIO_PORT_1,     GPIO_PIN_1,    PID_GPIO ) 	\
        RESERVE_GPIO(     INPUT_COL_4,    GPIO_PORT_1,     GPIO_PIN_0,    PID_GPIO ) 	\
        RESERVE_GPIO(     INPUT_COL_5,    GPIO_PORT_3,     GPIO_PIN_5,    PID_GPIO ) 	\
        RESERVE_GPIO(     INPUT_COL_6,    GPIO_PORT_2,     GPIO_PIN_3,    PID_GPIO ) 	\
        ...
        RESERVE_GPIO(    OUTPUT_ROW_2,    GPIO_PORT_1,     GPIO_PIN_2,    PID_GPIO ) 	\
        RESERVE_GPIO(    OUTPUT_ROW_3,    GPIO_PORT_1,     GPIO_PIN_3,    PID_GPIO ) 	\
        DECLARE_EEPROM_PINS                                                          	\
        DECLARE_LED_PINS                                                             	\
...
#endif //_APP_KBD_KEY_MATRIX_SETUP_8001_H_
